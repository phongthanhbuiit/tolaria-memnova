    ...
    const html = buildReleaseHistoryPage([
      {
        ...
        html_url: 'https://github.com/phongthanhbuiit/tolaria-memnova/releases/tag/stable-v2026.4.19',
      ...
      },
      {
        ...
        html_url: 'https://github.com/phongthanhbuiit/tolaria-memnova/releases/tag/2026.4.19-alpha.1',
    ...
    const html = buildReleaseHistoryPage([
      {
        ...
        body_html: [
          ...
          '<ul>',
          '<li><a href="https://github.com/phongthanhbuiit/tolaria-memnova/commit/ee71a00">ee71a00</a> feat: add paste without formatting command</li>',
          '</ul>',
        ].join(''),
        html_url: 'https://github.com/phongthanhbuiit/tolaria-memnova/releases/tag/stable-v2026.5.2',
    ...
    const html = buildReleaseHistoryPage([
      {
        ...
        html_url: 'https://github.com/phongthanhbuiit/tolaria-memnova/releases/tag/stable-v2026.5.13',
      ...
      },
      {
        ...
        html_url: 'https://github.com/phongthanhbuiit/tolaria-memnova/releases/tag/v2026-05-13',
